<template>
  <div class="register-first">
    <div class="register-header" v-if="type === 2">
      <div class="line-title">登记人员类型选择</div>
      <div class="radio">
        <el-radio
      ...
      <div class="line-title">请输入租赁对象信息</div>
    </div>
  ...
  methods: {
    submitForm (formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          this.$emit('toSecondPage', [2, this.ruleForm.roomId, this.personType])
        } else {
